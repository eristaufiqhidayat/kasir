...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <table class="table w-50 table-bordered table-hover" id="tanggal_laporan">
                <tr>
                  <td>Pilih Tanggal Laporan</td>
                  <td>:</td>
                  <td>
                    <div class="form-inline"><input id="tanggal" class="form-control" type=date onchange="changeDate()"></div>
                  </td>
                </tr>
              </table><br><br>
              <table class="table table-bordered" id="resume_penjualan">
                <thead>
                  <tr>
  ...
  <script>
    ...
    var getSummary = '<?php echo site_url('transaksi/getSummary') ?>';
